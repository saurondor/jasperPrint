...
public class LabelRow {
	...
	public LabelRow(String bib, String firstName, String lastName,
			String middleName, String fullName, String email, Integer age,
			String gender, Date birthDate, String category, String categoryKey,
			String registrationConfirmation, String registrationOperation,
			String paymentConfirmation, String paymentAmount, String eventName,
			String subeventName, String address, String extra1, String extra2,
			String extra3, String extra4, String extra5, Date registrationDate,
			String team, String procedence, Image barcode) {
		super();
		this.bib = bib;
